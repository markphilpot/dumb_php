...
<ul class="box">
	...
	<li{if $loc == 'freshmen'} id="active"{/if}><a href="freshmen.php">Admitted Freshmen<span class="tab-l"></span><span class="tab-r"></span></a></li>
	<li{if $loc == 'current'} id="active"{/if}><a href="current.php">Current Members<span class="tab-l"></span><span class="tab-r"></span></a></li>
	<li{if $loc == 'leadership'} id="active"{/if}><a href="leadership.php">Leadership<span class="tab-l"></span><span class="tab-r"></span></a></li>
    <li{if $loc == 'information'} id="active"{/if}><a href="dim.php">Information<span class="tab-l"></span><span class="tab-r"></span></a></li>
