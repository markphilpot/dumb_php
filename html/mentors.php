...
$t->assign('front', $db->getAll("select * from dumb_content where loc='mentors'"));

$t->assign('loc', 'resources');

$t->assign('breadcrumb', "<a href='index.php'>Home</a> > <a href='resources.php'>Member Resources</a> > Mentors");
